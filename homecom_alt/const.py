...
BOSCHCOM_ENDPOINT_ENERGY_GAS_UNIT: Final[str] = "/resource/energy/gas/unit"
...
BOSCHCOM_ENDPOINT_CP_CONF_CHARGING_STRATEGY: Final[str] = "/conf/chargingStrategy"
BOSCHCOM_ENDPOINT_CP_CMD_AUTHENTICATE: Final[str] = "/cmd/authenticate"
